    ...
    suspend fun processPremiumMessage(message: String, apiKey: String): String = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val systemInstruction = """
                ...
                If they are logging work (e.g., "Flat 101 brick work done by John"), figure out the flatId, workColumnId, and optionally masonId.
                ...
                If you cannot determine BOTH the flat and the work category, OR if the user is just asking a general question or chit-chatting, return:
                {
                   "action": "chat",
